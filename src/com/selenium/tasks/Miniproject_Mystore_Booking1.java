...
public class Miniproject_Mystore_Booking1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		WebElement evngdresses = driver.findElement(By.xpath("(//a[text()='Evening Dresses'])[2]"));
		act.click(evngdresses).build().perform();
		
		WebElement image = driver.findElement(By.xpath("(//a[@title='Printed Dress'])[1]"));
		...
		WebElement pinkclr = driver.findElement(By.xpath("//a[@id='color_24']"));
		pinkclr.click();
...
//		Thread.sleep(3000);
		...
		File destination = new File("C:\\Users\\user\\eclipse-workspace\\Selenium Tasks\\Screenshot\\MS1cart1.png");
		...
		File destination1 = new File("C:\\Users\\user\\eclipse-workspace\\Selenium Tasks\\Screenshot\\MS1cart2.png");		
